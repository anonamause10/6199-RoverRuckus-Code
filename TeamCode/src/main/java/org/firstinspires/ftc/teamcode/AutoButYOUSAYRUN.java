 ...
 */
@Disabled
@Autonomous(name = "WE running bois")
...
public class AutoButYOUSAYRUN extends LinearOpMode{
    ...
    private SoundPlayer sound = new SoundPlayer(1,1);
...
// and named "imu".
        ...
        File music = null;
        try {
           music = new File("/Phone/Runn.mp3");

        }catch(Exception e){e.printStackTrace();}
        sound.preload(this.hardwareMap.appContext, music);
        ...
        waitForStart();
        runtime.reset();
        sound.startPlaying(this.hardwareMap.appContext, music);
        linAct.setPower(-1);
        sleep(7100);
        linAct.setPower(0);
